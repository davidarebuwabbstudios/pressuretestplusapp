...
type RootStackParamList = {
    CompleteTypeOneTestScreen: undefined;
};

type Props = NativeStackScreenProps<
  RootStackParamList,
  "CompleteTypeOneTestScreen"
>;

function CompleteTypeOneTestScreen({ navigation }: Props) {
...
export default CompleteTypeOneTestScreen;
